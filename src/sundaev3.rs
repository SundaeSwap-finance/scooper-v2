...
//#[derive(Clone, AsPlutus, Debug, PartialEq, Eq, Hash, PartialOrd, Ord)]
...
mod tests {
    ...
    fn test_decode_orderdatum() {
        ...
        assert_eq!(order.destination, Destination::Fixed(
            PlutusAddress {
        ...
        assert_eq!(order.action, Order::Swap(
            (
                vec![0],
                vec![1],
                BigInt::Int(2.into()),
